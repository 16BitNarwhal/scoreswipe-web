      ...
      <div className="mx-auto flex max-w-6xl flex-col-reverse items-center gap-10 md:flex-row">
        <div className="w-full md:w-1/2">
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            ...
            <Link
              href="/about"
              className="inline-flex items-center justify-center rounded-full border border-brand-400 px-8 py-3 text-base font-semibold text-brand-400 transition hover:border-brand-300 hover:text-brand-300"
            >
              Learn more
            </Link>
          </div>
